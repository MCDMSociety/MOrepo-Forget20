...
slvd <- c(perfPrelim[[11]][1],perfPrelim[[11]][2],perfPrelim[[11]][3],perfPrelim[[11]][4]) # TO BE CHANGED DEPENDING OF NB OF CONFIG, slvd[i] = 1 if config i solved, 0 otherwise
...
Y <- perfPrelim[[12]][1]
slvd <- c(perfPrelim[[11]][1],perfPrelim[[11]][2],perfPrelim[[11]][3],perfPrelim[[11]][4])
