...
ggplot(aes(x = cpu, y = pct, color = mth), data = res ) + 
   geom_step() +
   geom_jitter(size = 0.9, width = 0, height = height) +
...
# ex where cpu total is below 
# inst <- "Forget20-KP_10_3_1-1000_spheredown_2_10"
# tmp1 <- read_csv("../convert/data/stat.csv", col_types = cols())
# filter(tmp1, instance == "Forget20-KP_10_3_1-1000_spheredown_2_10.raw") %>% 
#    select(nodesel, varsel, OB, tpstotal)
# mth <- paste0(nodesel, "_", varsel, "_", tolower(ob)) %>%
#       str_replace_all(c("breadth" = "b", "depth" = "d", "none" = "-2", "cone" = "1", "exact" = "2"))
# read_csv("../convert/data/details/UBrun/Forget20-KP_10_3_1-1000_spheredown_2_10_b_mfavg_-2_UB.csv")
```
