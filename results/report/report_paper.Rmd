...
The performance of the branch and bound algorithm compared to the Objective Space Search (OSS) algorithm is shown in Figure \@ref(fig:perfPlotPctOss). In general the OSS algorithm performs better that the branch and bound algorithm. This is expected since 
