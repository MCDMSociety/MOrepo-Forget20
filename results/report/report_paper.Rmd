...
We think that closing this gap is possible with further research in pruning nodes and finding lower bound sets faster (i.e. processing nodes faster) or by considering alternative node and variable selection rules (i.e. reducing the size of the tree and thus, decreasing this factor of `r round(mean(tmp$fct1))`).
