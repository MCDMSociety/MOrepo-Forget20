...
Finally, consider the winning algorithm configurations in Figure \@ref(fig:winConfigs). Note that for KP and UFLP, no objective branching is competitive for some of the smaller instances. Furthermore, in general there is not configuration that wins. That is, algorithms using different node selection and objective branching strategies during the solution procedure may be useful. 
