...
branch–and–bound algorithm. All algorithms have been implemented in Julia $1.0.1$. The experiments have been done on a computer with an Intel(R) Core(TM) i7-4785T CPU @ 2.20GHz processor and 16GB of RAM memory, using Linux Ubuntu 14.04 LTS.
...
[LRN: add instances with only cone and none as well]
...
[LRN: I think we can drop gapO and ratio, I don't think it adds much of information here, especially since we only have spheredown instances]
...
# Comparison of the performance of the different configurations
